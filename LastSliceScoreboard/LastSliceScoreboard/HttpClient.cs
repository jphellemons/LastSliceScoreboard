...
namespace LastSliceScoreboard
{
    public class HttpClient
    {
        ...
        public async Task<HttpResponseMessage> GetUrlAsync(string url)
        {
            ...
            //httpClient.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", Convert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(token)));
        ...
        public async Task<HttpResponseMessage> PostUrlAsync(string url, string body)
        {
            ...
            var stringBody = new StringContent(body, UnicodeEncoding.UTF8, "application/json");
